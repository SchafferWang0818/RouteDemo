...
//                startAMapNavi(marker);
                // TODO: 2016/11/20 获得当前位置的坐标和地点名称进行返回
                LatLng latLng = marker.getOptions().getPosition();
                String positionName = searchText.getText().toString();
                Intent intent = new Intent();
                intent.putExtra("position", new SerializableBean(positionName, latLng.latitude, latLng.longitude));
